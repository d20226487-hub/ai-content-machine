...
export const en = {
  ...
  "tableCost.tool.ai_helper": "AI helper",
  ...
  "dashboard.activityTitle": "Active processes",
  "dashboard.activitySubtitle":
    "Everything queued or running across all users. On-demand — nothing updates until you check.",
  "dashboard.activityCheck": "Check now",
  "dashboard.activityRefresh": "Refresh",
  "dashboard.activityChecking": "Checking…",
  "dashboard.activityCount": "{n} active",
  "dashboard.activityCheckedAt": "checked at {time}",
  "dashboard.activityEmpty": "Nothing running or queued right now.",
  "dashboard.activityBy": "by {owner}",
  "dashboard.activityAgo": "{ago} ago",
  "dashboard.activityOpen": "Open →",
  "dashboard.status.running": "running",
  "dashboard.status.queued": "queued",
  "dashboard.status.paused": "paused",
  "dashboard.kind.autotool": "Autotool send",
  "dashboard.kind.generation": "AI generation",
  "dashboard.kind.publish": "Publish",
  "dashboard.kind.gdocs_import": "Google Docs import",
  "dashboard.kind.domain_cache": "Domain cache",
  "dashboard.kind.language_sync": "Language sync",
  "dashboard.kind.link_check": "Link check",
  "dashboard.kind.link_fix": "Link fix",
  "dashboard.kind.structure_format": "Structure format",
  "dashboard.kind.csv_export": "CSV export",
  "dashboard.kind.backup": "Backup",
  ...
  "test.varsHeading": "Variables",
  "test.varsFilled": "{filled} of {total} filled",
  ...
  "autotool.columnsBtn": "Columns {n}/{total}",
  "autotool.columnsHint": "Choose which columns the Autotool CSV includes",
  "autotool.columnsLabel": "Columns to include",
  "autotool.columnsNoneWarning": "Select at least one column.",
  "autotool.columnsTitle": "Autotool columns",
  ...
  "common.back": "Back",
  // ---------- add-domain wizard ----------
  "addDomain.title": "Add domain",
  "addDomain.chooseHint": "Pick the CMS type. Custom CMS domains are added as a list.",
  "addDomain.custom": "Custom CMS",
  "addDomain.customHint": "Bulk add: paste a list of domains with languages. Endpoint, body template and password come from Settings.",
  "addDomain.wordpress": "WordPress",
  "addDomain.wordpressHint": "Full form: publish profiles and the app password are set per site.",
  "addDomain.proceed": "Proceed",
  "addDomain.pasteHint": "One domain per line: domain.com - en, es, ru. The first language is the default.",
  "addDomain.noPassword": "The shared Custom CMS password isn't set — adding will fail.",
  "addDomain.noPasswordLink": "Set it in Settings",
  "addDomain.appliedConfig": "Applied to every domain: {endpoint}",
  "addDomain.updateExisting": "Update existing domains",
  "addDomain.updateExistingHint": "Overwrites languages and config for domains that already exist. Unchecked, they're skipped.",
  "addDomain.submit": "Add",
  "addDomain.resultSummary": "Created: {created} · Updated: {updated} · Skipped: {skipped}",
  "addDomain.lineNo": "line {n}:",
  "domainMod.cmsFilms": "Films",
  "domainMod.filmsSharedCreds": "Login and password are shared by all Films sites — change them in Settings → Publishing → Films.",
  "addDomain.films": "Films",
  "addDomain.filmsHint": "Bulk add: paste a list of domains, no languages. Login and password come from Settings.",
  "addDomain.filmsPasteHint": "One domain per line, e.g. films-site.com.",
  "addDomain.filmsNoPassword": "The shared Films login/password isn't set — adding will fail.",
  "addDomain.filmsUpdateExistingHint": "Re-applies the shared login/password to Films sites that already exist. Unchecked, they're skipped.",
  "filmsCms.title": "Films",
  "filmsCms.subtitle": "Shared access to all Films sites (basic auth) — separate from Custom CMS.",
  "filmsCms.endpoint": "Imports are sent to",
  "filmsCms.login": "Login",
  "filmsCms.password": "Password",
  "filmsCms.appliesTo": "A new password is applied to all Films sites at once ({n}). Stored encrypted and never shown.",
  "bulkPub.cmsTypeFilms": "Films",
  "bulkPub.cmsTypeFilmsHint": "Film sites: published through their CSV import (/import/api.php), one row per request.",
  "bulkPub.filmsNews": "Film",
  "bulkPub.filmsCategory": "Category",
  "bulkPub.filmsComment": "Comment",
  "bulkPub.filmsNewsCreateHint": "Adds new films only. If the film already exists (by Kinopoisk ID or exact Title), the row is marked “already exists”.",
  ...
  "bulkPub.filmsCommentNeedFilm": "Map Film URL or Film Name — that's how the site finds the film.",
  "bulkPub.filmsCommentNeedText": "Map at least one Comment column.",

  // ---------- shared Custom CMS settings ----------
  "customCms.title": "Custom CMS — shared settings",
  "customCms.subtitle": "One config for every Custom CMS site: endpoint, request body and password. Applied to new domains added from a list.",
  "customCms.endpoint": "Endpoint path",
  "customCms.password": "Password (basic auth)",
  "customCms.passwordSet": "Set — type a new value to replace",
  "customCms.passwordEmpty": "login:password",
  "customCms.passwordHint": "Stored encrypted and never shown again. One password for all Custom CMS sites.",
  "customCms.idPath": "Response ID path",
  "customCms.urlPath": "Response URL path",
  "customCms.body": "Body template (JSON)",
  "customCms.bodyHint": "Placeholders {{lang}}, {{slug}}, {{title}}, {{content}} etc. are substituted at publish time.",
  "customCms.bodyInvalid": "Invalid JSON — an object is expected.",
  "customCms.reapplyTitle": "Apply to all existing domains",
  "customCms.reapplyHint": "Overwrites the endpoint, body template and password on EVERY Custom CMS domain. Languages and names are untouched. Cannot be undone.",
  "customCms.reapplyButton": "Apply to all…",
  ...
  "tools.aiHelper.title": "AI helper",
  "tools.aiHelper.desc":
    "Give a prompt + columns; AI reads or edits every row. Read or Edit mode, revertable.",
  "aiHelper.backToTable": "← Back to table",
  "aiHelper.backToTool": "← Back to AI helper",
  "aiHelper.title": "AI helper",
  "aiHelper.onTable": "On table: {name}",
  "aiHelper.engineLabel": "Engine",
  "aiHelper.engine.structured": "Structured (one call per row)",
  "aiHelper.engine.per_output": "Per output (one call each)",
  "aiHelper.engineHint.structured":
    "Cheapest — one AI call per row returns a JSON object with a key per output column.",
  "aiHelper.engineHint.per_output":
    "One focused AI call per output column, each with its own prompt. More calls, simpler prompts.",
  "aiHelper.engineTag": "{engine} · {n} column(s)",
  "aiHelper.engineShort.structured": "Structured",
  "aiHelper.engineShort.per_output": "Per-output",
  "aiHelper.historyHeading": "Recent runs",
  "aiHelper.promptLabel": "Prompt",
  "aiHelper.fromLibrary": "Load from library…",
  "aiHelper.promptPlaceholder":
    "e.g. Extract a meta description from {{Content}} and return only the description.",
  "aiHelper.promptHint":
    "Reference columns with {{Column Name}}; each one becomes a mapping below.",
  "aiHelper.promptPlaceholderStructured":
    "e.g. From {{Content}} produce an SEO meta title and a meta description.",
  "aiHelper.promptHintStructured":
    "Reference columns with {{Column Name}}. The model returns a JSON object with one key per output column below.",
  "aiHelper.mapLabel": "Map each variable to a column",
  "aiHelper.pickColumn": "— pick column —",
  "aiHelper.modeLabel": "Mode",
  "aiHelper.mode.read": "Read → write to a column",
  "aiHelper.mode.edit": "Edit in place",
  "aiHelper.targetRead": "Write output to",
  "aiHelper.targetEdit": "Column to rewrite",
  "aiHelper.editTargetWarn":
    "Edit mode rewrites this column, so it must also be one of the prompt's {{variables}}.",
  "aiHelper.outputsLabel": "Outputs",
  "aiHelper.addOutput": "+ Add output",
  "aiHelper.removeOutput": "Remove output",
  "aiHelper.out.write": "Write → new content",
  "aiHelper.out.edit": "Edit in place",
  "aiHelper.out.key": "JSON key",
  "aiHelper.out.prompt": "Prompt for this output",
  "aiHelper.outputsDistinctWarn": "Each output must target a different column.",
  "aiHelper.outputsHintStructured":
    "The model returns each key exactly; a missing key leaves that column unchanged.",
  "aiHelper.inputScopeLabel": "Input scope",
  "aiHelper.scopeFull": "Whole cell",
  "aiHelper.scopeFirstPct": "First",
  "aiHelper.ofColumn": "of",
  "aiHelper.scopeHint":
    "Sends only the first N% of the column's words (rounded to a whole HTML block). In Edit mode the reply is spliced back onto the rest.",
  "aiHelper.modelLabel": "Model (optional)",
  "aiHelper.modelDefault": "Default (cheapest enabled)",
  "aiHelper.maxOutLabel": "Max output tokens",
  "aiHelper.maxOutPlaceholder": "default",
  "aiHelper.rowsLabel": "Rows",
  "aiHelper.rowsAll": "All rows",
  "aiHelper.rowsTest": "Test: first N rows",
  "aiHelper.rowsRange": "Range",
  "aiHelper.rowsTo": "to",
  "aiHelper.rowsRangeHint":
    "By row number, inclusive — set both to the same number for one row. Table has {total} row(s).",
  "aiHelper.previewBtn": "Preview cost",
  "aiHelper.confirmLine":
    "This runs {calls} AI call(s) over {rows} row(s) with {model} — est. {cost}. Continue?",
  "aiHelper.costUnknown": "cost unknown (no rate configured)",
  "aiHelper.runBtn": "Run now",
  "aiHelper.starting": "Starting…",
  "aiHelper.runLabel": "AI helper run #{id}",
  "aiHelper.modeTag": "Mode: {mode}",
  "aiHelper.reverted": "reverted",
  "aiHelper.statDone": "{done}/{total} done",
  "aiHelper.statFailed": "{n} failed",
  "aiHelper.statSkipped": "{n} skipped",
  "aiHelper.cancelBtn": "Cancel",
  "aiHelper.retryBtn": "Retry {n} failed",
  "aiHelper.revertBtn": "Revert",
  "aiHelper.revertConfirm": "Restore every cell this run changed to its previous value?",
  "aiHelper.colRow": "Row",
  "aiHelper.colColumn": "Column",
  "aiHelper.colState": "State",
  "aiHelper.colResult": "Result",
  "aiHelper.cellState.pending": "pending",
  "aiHelper.cellState.done": "done",
  "aiHelper.cellState.failed": "failed",
  "aiHelper.cellState.skipped": "skipped",

  // ---------- pagination ----------
  // ---------- statistics ----------
  "stats.title": "Statistics",
  "stats.subtitle": "Bulk generations, publications and AI spend, grouped by month.",
  "stats.period": "Period",
  "stats.lastN": "Last {n} months",
  "stats.month": "Month",
  "stats.allMonths": "All months",
  "stats.user": "User",
  "stats.allUsers": "All users",
  "stats.domain": "Domain",
  "stats.allDomains": "All domains",
  "stats.onlyContent": "Content only",
  "stats.onlyContentHint":
    "Count only publications that shipped a non-empty content field. Custom CMS is checked per post; Autotool always includes content.",
  "stats.domainScopedNote":
    "Generations and spend aren't tied to a domain — with a domain filter only publications are shown.",
  "stats.byMonth": "By month",
  "stats.errors": "Errors",
  "stats.successful": "Successful",
  "stats.breakdown": "Breakdown",
  "stats.by.user": "By user",
  "stats.by.table": "By table",
  "stats.by.domain": "By domain",
  "stats.by.channel": "By channel",
  "stats.total": "Total",
  "stats.empty": "No data for these filters.",
  "stats.colMonth": "Month",
  "stats.colRuns": "Gen. runs",
  "stats.colRunsHint": "Number of bulk-generation runs (batches).",
  "stats.colCells": "Generated",
  "stats.colCellsHint": "Cells filled by AI generation — one per generated text.",
  "stats.colCustom": "Custom CMS",
  "stats.colAutotool": "Autotool",
  "stats.colGeneration": "Generation",
  "stats.colCost": "Cost",
