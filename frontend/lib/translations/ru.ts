...
export const ru: Record<keyof typeof en, string> = {
  ...
  "tableCost.tool.ai_helper": "AI-помощник",
  ...
  "dashboard.activityTitle": "Активные процессы",
  "dashboard.activitySubtitle":
    "Всё, что стоит в очереди или выполняется у всех пользователей. По запросу — ничего не обновляется, пока вы не проверите.",
  "dashboard.activityCheck": "Проверить",
  "dashboard.activityRefresh": "Обновить",
  "dashboard.activityChecking": "Проверяем…",
  "dashboard.activityCount": "{n} активных",
  "dashboard.activityCheckedAt": "проверено в {time}",
  "dashboard.activityEmpty": "Сейчас ничего не выполняется и не стоит в очереди.",
  "dashboard.activityBy": "от {owner}",
  "dashboard.activityAgo": "{ago} назад",
  "dashboard.activityOpen": "Открыть →",
  "dashboard.status.running": "выполняется",
  "dashboard.status.queued": "в очереди",
  "dashboard.status.paused": "приостановлено",
  "dashboard.kind.autotool": "Отправка в Autotool",
  "dashboard.kind.generation": "AI-генерация",
  "dashboard.kind.publish": "Публикация",
  "dashboard.kind.gdocs_import": "Импорт из Google Docs",
  "dashboard.kind.domain_cache": "Кэш доменов",
  "dashboard.kind.language_sync": "Синхронизация языков",
  "dashboard.kind.link_check": "Проверка ссылок",
  "dashboard.kind.link_fix": "Исправление ссылок",
  "dashboard.kind.structure_format": "Форматирование структуры",
  "dashboard.kind.csv_export": "Экспорт CSV",
  "dashboard.kind.backup": "Резервная копия",
  ...
  "test.varsHeading": "Переменные",
  "test.varsFilled": "Заполнено {filled} из {total}",
  ...
  "autotool.columnsBtn": "Колонки {n}/{total}",
  "autotool.columnsHint": "Выберите, какие колонки войдут в CSV для Autotool",
  "autotool.columnsLabel": "Колонки для включения",
  "autotool.columnsNoneWarning": "Выберите хотя бы одну колонку.",
  "autotool.columnsTitle": "Колонки Autotool",
  ...
  "common.back": "Назад",
  // ---------- добавление доменов (мастер) ----------
  "addDomain.title": "Добавить домен",
  "addDomain.chooseHint": "Выберите тип CMS. Для Custom CMS домены добавляются списком.",
  "addDomain.custom": "Custom CMS",
  "addDomain.customHint": "Массовое добавление: вставьте список доменов с языками. Эндпоинт, тело запроса и пароль берутся из настроек.",
  "addDomain.wordpress": "WordPress",
  "addDomain.wordpressHint": "Обычная форма: профили публикации и пароль приложения задаются для каждого сайта отдельно.",
  "addDomain.proceed": "Продолжить",
  "addDomain.pasteHint": "По одному домену в строке: domain.com - en, es, ru. Первый язык — основной.",
  "addDomain.noPassword": "Общий пароль Custom CMS не задан — добавление не сработает.",
  "addDomain.noPasswordLink": "Задать в настройках",
  "addDomain.appliedConfig": "Ко всем доменам применится: {endpoint}",
  "addDomain.updateExisting": "Обновлять существующие домены",
  "addDomain.updateExistingHint": "Перезапишет языки и конфигурацию у доменов, которые уже есть. Без галочки они пропускаются.",
  "addDomain.submit": "Добавить",
  "addDomain.resultSummary": "Создано: {created} · Обновлено: {updated} · Пропущено: {skipped}",
  "addDomain.lineNo": "строка {n}:",

  // ---------- общие настройки Custom CMS ----------
  "customCms.title": "Custom CMS — общие настройки",
  "customCms.subtitle": "Одна конфигурация для всех сайтов Custom CMS: эндпоинт, тело запроса и пароль. Применяется к новым доменам при добавлении списком.",
  "customCms.endpoint": "Endpoint path",
  "customCms.password": "Пароль (basic auth)",
  "customCms.passwordSet": "Задан — введите новое значение для замены",
  "customCms.passwordEmpty": "логин:пароль",
  "customCms.passwordHint": "Хранится в зашифрованном виде; после сохранения не показывается. Один на все сайты Custom CMS.",
  "customCms.idPath": "Response ID path",
  "customCms.urlPath": "Response URL path",
  "customCms.body": "Body template (JSON)",
  "customCms.bodyHint": "Плейсхолдеры {{lang}}, {{slug}}, {{title}}, {{content}} и т. д. подставляются при публикации.",
  "customCms.bodyInvalid": "Некорректный JSON — ожидается объект.",
  "customCms.reapplyTitle": "Применить ко всем существующим доменам",
  "customCms.reapplyHint": "Перезапишет эндпоинт, тело запроса и пароль у ВСЕХ доменов Custom CMS. Языки и названия не затрагиваются. Отменить нельзя.",
  "customCms.reapplyButton": "Применить ко всем…",
  "customCms.reapplyConfirm": "Перезаписать конфигурацию всех доменов Custom CMS?",
  ...
  "tools.aiHelper.title": "AI-помощник",
  "tools.aiHelper.desc":
    "Задайте промпт + колонки; ИИ читает или редактирует каждую строку. Режимы Read/Edit, откатывается.",
  "aiHelper.backToTable": "← Назад к таблице",
  "aiHelper.backToTool": "← Назад к AI-помощнику",
  "aiHelper.title": "AI-помощник",
  "aiHelper.onTable": "Таблица: {name}",
  "aiHelper.engineLabel": "Движок",
  "aiHelper.engine.structured": "Структурный (один вызов на строку)",
  "aiHelper.engine.per_output": "По выходу (по вызову на каждый)",
  "aiHelper.engineHint.structured":
    "Дешевле всего — один вызов ИИ на строку возвращает JSON-объект с ключом для каждой выходной колонки.",
  "aiHelper.engineHint.per_output":
    "Отдельный вызов ИИ на каждую выходную колонку со своим промптом. Больше вызовов, но проще промпты.",
  "aiHelper.engineTag": "{engine} · колонок: {n}",
  "aiHelper.engineShort.structured": "Структурный",
  "aiHelper.engineShort.per_output": "По выходу",
  "aiHelper.historyHeading": "Недавние запуски",
  "aiHelper.promptLabel": "Промпт",
  "aiHelper.fromLibrary": "Загрузить из библиотеки…",
  "aiHelper.promptPlaceholder":
    "напр. Извлеки meta description из {{Content}} и верни только описание.",
  "aiHelper.promptHint":
    "Ссылайтесь на колонки как {{Имя колонки}}; каждая станет сопоставлением ниже.",
  "aiHelper.promptPlaceholderStructured":
    "напр. Из {{Content}} сделай SEO meta title и meta description.",
  "aiHelper.promptHintStructured":
    "Ссылайтесь на колонки как {{Имя колонки}}. Модель вернёт JSON-объект с одним ключом на каждую выходную колонку ниже.",
  "aiHelper.mapLabel": "Сопоставьте каждую переменную с колонкой",
  "aiHelper.pickColumn": "— выберите колонку —",
  "aiHelper.modeLabel": "Режим",
  "aiHelper.mode.read": "Read → записать в колонку",
  "aiHelper.mode.edit": "Edit — править на месте",
  "aiHelper.targetRead": "Записать результат в",
  "aiHelper.targetEdit": "Колонка для перезаписи",
  "aiHelper.editTargetWarn":
    "В режиме Edit эта колонка перезаписывается, поэтому она должна быть и одной из {{переменных}} промпта.",
  "aiHelper.outputsLabel": "Выходные колонки",
  "aiHelper.addOutput": "+ Добавить выход",
  "aiHelper.removeOutput": "Удалить выход",
  "aiHelper.out.write": "Записать → новый текст",
  "aiHelper.out.edit": "Править на месте",
  "aiHelper.out.key": "JSON-ключ",
  "aiHelper.out.prompt": "Промпт для этого выхода",
  "aiHelper.outputsDistinctWarn": "Каждый выход должен указывать на свою колонку.",
  "aiHelper.outputsHintStructured":
    "Модель возвращает каждый ключ точно; отсутствующий ключ оставляет колонку без изменений.",
  "aiHelper.inputScopeLabel": "Объём ввода",
  "aiHelper.scopeFull": "Вся ячейка",
  "aiHelper.scopeFirstPct": "Первые",
  "aiHelper.ofColumn": "от",
  "aiHelper.scopeHint":
    "Отправляет только первые N% слов колонки (с округлением до целого HTML-блока). В режиме Edit ответ вставляется обратно к остатку.",
  "aiHelper.modelLabel": "Модель (необязательно)",
  "aiHelper.modelDefault": "По умолчанию (самая дешёвая)",
  "aiHelper.maxOutLabel": "Макс. выходных токенов",
  "aiHelper.maxOutPlaceholder": "по умолчанию",
  "aiHelper.rowsLabel": "Строки",
  "aiHelper.rowsAll": "Все строки",
  "aiHelper.rowsTest": "Тест: первые N строк",
  "aiHelper.rowsRange": "Диапазон",
  "aiHelper.rowsTo": "по",
  "aiHelper.rowsRangeHint":
    "По номеру строки, включительно — укажите одинаковые значения для одной строки. Всего строк: {total}.",
  "aiHelper.previewBtn": "Оценить стоимость",
  "aiHelper.confirmLine":
    "Будет {calls} вызов(ов) ИИ по {rows} строк(ам) с {model} — оценка {cost}. Продолжить?",
  "aiHelper.costUnknown": "стоимость неизвестна (нет тарифа)",
  "aiHelper.runBtn": "Запустить",
  "aiHelper.starting": "Запуск…",
  "aiHelper.runLabel": "Запуск AI-помощника #{id}",
  "aiHelper.modeTag": "Режим: {mode}",
  "aiHelper.reverted": "откачено",
  "aiHelper.statDone": "{done}/{total} готово",
  "aiHelper.statFailed": "{n} с ошибкой",
  "aiHelper.statSkipped": "{n} пропущено",
  "aiHelper.cancelBtn": "Отменить",
  "aiHelper.retryBtn": "Повторить {n} с ошибкой",
  "aiHelper.revertBtn": "Откатить",
  "aiHelper.revertConfirm": "Вернуть все изменённые этим запуском ячейки к прежним значениям?",
  "aiHelper.colRow": "Строка",
  "aiHelper.colColumn": "Колонка",
  "aiHelper.colState": "Статус",
  "aiHelper.colResult": "Результат",
  "aiHelper.cellState.pending": "в очереди",
  "aiHelper.cellState.done": "готово",
  "aiHelper.cellState.failed": "ошибка",
  "aiHelper.cellState.skipped": "пропущено",

  // ---------- пагинация ----------
  // ---------- statistics ----------
  "stats.title": "Статистика",
  "stats.subtitle": "Массовые генерации, публикации и расходы на ИИ по месяцам.",
  "stats.period": "Период",
  "stats.lastN": "Последние {n} мес.",
  "stats.month": "Месяц",
  "stats.allMonths": "Все месяцы",
  "stats.user": "Пользователь",
  "stats.allUsers": "Все",
  "stats.domain": "Домен",
  "stats.allDomains": "Все",
  "stats.onlyContent": "Только с контентом",
  "stats.onlyContentHint":
    "Считать только публикации, где был отправлен непустой контент. Custom CMS проверяется по каждому посту; Autotool всегда включает контент.",
  "stats.domainScopedNote":
    "Генерация и расходы не привязаны к домену — при фильтре по домену показаны только публикации.",
  "stats.byMonth": "По месяцам",
  "stats.errors": "Ошибки",
  "stats.successful": "Успешно",
  "stats.breakdown": "Разбивка",
  "stats.by.user": "По пользователю",
  "stats.by.table": "По таблице",
  "stats.by.domain": "По домену",
  "stats.by.channel": "По каналу",
  "stats.total": "Итого",
  "stats.empty": "Нет данных по выбранным фильтрам.",
  "stats.colMonth": "Месяц",
  "stats.colRuns": "Запуски",
  "stats.colRunsHint": "Число запусков массовой генерации (батчей).",
  "stats.colCells": "Сгенерировано",
  "stats.colCellsHint": "Ячейки, заполненные генерацией ИИ — по одной на каждый текст.",
  "stats.colCustom": "Custom CMS",
  "stats.colAutotool": "Autotool",
  "stats.colGeneration": "Генерация",
  "stats.colCost": "Стоимость",
