...
export const ru: Record<keyof typeof en, string> = {
  ...
  "domains.bulkCache": "Кэш…",
  "domains.bulkCacheHint": "Очистить и/или прогреть кэш выбранных доменов Custom CMS",
  "cacheModal.title": "Очистка / прогрев кэша",
  ...
  "cacheModal.actionHint_clear": "Сбросить кэш каждого сайта (/index.php?_clear_cache).",
  "cacheModal.actionHint_warm": "Перестроить кэш каждого сайта (/index.php?__warm_cache).",
  "cacheModal.actionHint_clear_and_warm": "Сбросить, затем перестроить — последовательно для каждого сайта.",
