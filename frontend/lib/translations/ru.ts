...
export const ru: Record<keyof typeof en, string> = {
  ...
  "domainMod.cmsFilms": "Фильмы",
  "domainMod.filmsSharedCreds": "Логин и пароль общие для всех сайтов фильмов — меняются в Настройки → Публикация → Фильмы.",
  "addDomain.films": "Фильмы",
  "addDomain.filmsHint": "Массовое добавление: вставьте список доменов, без языков. Логин и пароль берутся из настроек.",
  "addDomain.filmsPasteHint": "По одному домену в строке, например films-site.com.",
  "addDomain.filmsNoPassword": "Общий логин/пароль для сайтов фильмов не задан — добавление не сработает.",
  "addDomain.filmsUpdateExistingHint": "Заново применит общий логин/пароль к уже добавленным сайтам фильмов. Без галочки они пропускаются.",
  "filmsCms.title": "Фильмы",
  "filmsCms.subtitle": "Общий доступ ко всем сайтам фильмов (basic auth) — отдельный от Custom CMS.",
  "filmsCms.endpoint": "Импорт отправляется на",
  "filmsCms.login": "Логин",
  "filmsCms.password": "Пароль",
  "filmsCms.appliesTo": "Новый пароль сразу применится ко всем сайтам фильмов ({n}). Хранится в зашифрованном виде и не показывается.",
  "bulkPub.cmsTypeFilms": "Фильмы",
  "bulkPub.cmsTypeFilmsHint": "Сайты фильмов: публикация через CSV-импорт (/import/api.php), по строке на запрос.",
  "bulkPub.filmsNews": "Фильм",
  "bulkPub.filmsCategory": "Категория",
  "bulkPub.filmsComment": "Комментарий",
  "bulkPub.filmsNewsCreateHint": "Добавляет только новые фильмы. Если фильм уже есть (по Kinopoisk ID или точному Title), строка помечается «фильм уже существует».",
  ...
  "bulkPub.filmsCommentNeedFilm": "Сопоставьте Film URL или Film Name — по ним сайт находит фильм.",
  "bulkPub.filmsCommentNeedText": "Сопоставьте хотя бы одну колонку Comment.",
