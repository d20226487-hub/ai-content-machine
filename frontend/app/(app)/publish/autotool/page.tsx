...
export default function AutotoolConfigPage() {
  const { t } = useT();
  ...
  return (
    <div className="space-y-6 p-5">
      ...
      {loading ? (
        ...
        <section className="max-w-2xl rounded-lg border border-neutral-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900">
          {/* Target URL */}
