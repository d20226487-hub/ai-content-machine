...
class Domain(Base):
    ...
    # NULL = active, non-NULL = trashed. All publish surfaces filter
    # `deleted_at IS NULL`. Trashed domains are only visible via the
    # /domains/trash surface and cannot be picked as publish targets.
